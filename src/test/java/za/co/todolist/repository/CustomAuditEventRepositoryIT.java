package za.co.todolist.repository;

import za.co.todolist.TodolistApp;
import za.co.todolist.config.Constants;
import za.co.todolist.config.audit.AuditEventConverter;
import za.co.todolist.domain.PersistentAuditEvent;
...
import static za.co.todolist.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
